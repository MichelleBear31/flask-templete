...
# Updated CNN Model with Batch Normalization
model = Sequential()
...
# Adjust learning rate and use callbacks
reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=5, min_lr=0.001)
model.compile(optimizer=keras.optimizers.Adadelta(learning_rate=1.0),
              loss='categorical_crossentropy',
              metrics=['accuracy'])

# Train the model
model.fit(X_train, y_train, epochs=1000, batch_size=32, validation_data=(X_test, y_test), callbacks=[reduce_lr])
