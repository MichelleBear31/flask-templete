...
def main():
    ...
    if os.path.exists(model_path) or os.path.exists(history_path):
        ...
        if retrain == 'y':
            ...
            # 分割資料集
            output_train_dir = os.path.join(current_dir, 'LSTM_mfcc_train_test')
            output_test_dir = os.path.join(current_dir, 'LSTM_mfcc_test_test')
            ...
            try:
                ...
                categories = sorted(os.listdir(os.path.join(current_dir, 'LSTM_mfcc_train_test')))
